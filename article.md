...
![Частка небезпечних по регіонах](hazard_waste_regios.png)
...
![Небезпечні по галузях-частка від галузі](newplot%20(11).png)
...
![Поводження з відходами по країнах ЄС](newplot%20(12).png)
